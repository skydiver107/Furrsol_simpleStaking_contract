...
use anchor_lang::solana_program::{entrypoint::ProgramResult, clock::Clock, program_error::ProgramError};
use std::convert::Into;
use mpl_candy_machine::{self, Creator};
use crate::constants::*;
mod constants {
...
declare_id!("5tvBzSCacUn2maQkeaU7TzNX7rspSpEnxHagzZceaP7G");

#[program]
pub mod furrsol_extra_staking {
    use super::*;
